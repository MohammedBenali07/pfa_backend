...
# Build the application JAR, skipping tests completely
...
# The JAR name must match your project's artifact ID and version
COPY --from=builder /app/target/backend-pfa-0.0.1-SNAPSHOT.jar ./app.jar
